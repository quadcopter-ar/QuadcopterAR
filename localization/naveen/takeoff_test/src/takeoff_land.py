...
class rcOverride:
    def __init__(self, copter_id = "1", mavros_string="/mavros"):
...
class posVel:
    ...
    def takeoff_velocity(self, alt=7.0):
    ...
    def land_velocity(self):
        ...
        self.update(self.home_lat, self.home_lon, 1.0)
        alts = 1.0
