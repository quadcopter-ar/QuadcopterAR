...
class Solo(object):
    ...
    def __init__(self,solo_id):
        ...
        self.pub_thr = SP.get_pub_attitude_throttle(queue_size=10)
    ...
    def handle_joy(self,joy_data):
        ...
        self.current_joy_throttle = 0.5+magnitude*joy_data.axes[1]
